  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#020617', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <p style={{ textAlign: 'center', color: '#94a3b8', marginTop: '24px', fontSize: '14px' }}>Do not have an account?{' '}<Link href="/signup" style={{ color: '#f97316', textDecoration: 'none', fontWeight: '600' }}>Sign Up</Link></p>
      </div>
      </div>
    </div>
  )
