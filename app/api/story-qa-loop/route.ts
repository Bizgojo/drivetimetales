...
ENDING RULE: Every standalone MUST have a definitive ending. Apply the Difficult Solution Rule: the central problem should feel genuinely difficult at the beginning, the middle should reveal leverage and escalating consequences that make the solution possible, and the ending should feel emotionally and logically earned. The last 2 minutes should contain: (1) onstage climax or final revelation, (2) protagonist-driven decisive action, (3) resolution showing consequences, (4) closing image or moment that lands emotionally. Penalize offscreen solutions, exposition-only endings, passive protagonists, unresolved emotional arcs, coincidence/deus-ex-machina fixes, and "villain already dead" anticlimax. If the ending is ambiguous, trails off, leaves the central conflict unresolved, or the protagonist does not affect the outcome, give structure_and_pacing 4 or below. Test: could a listener summarize how the protagonist changed the outcome in one sentence? If not, the ending fails.
