...
export default function StoryProductionV2Page() {
  ...
  const filteredAuthors = useMemo(() => {
    ...
    return authors.filter((a) => String(a.primary_genre || '').toLowerCase() === g)
  }, [authors, form.genre])
    ...
    <div className="min-h-screen bg-[#FAF9F6] text-black px-6 py-8">
      <div className="max-w-7xl mx-auto space-y-6">
        <div>
          ...
          <div className="mt-2 inline-block rounded bg-yellow-200 px-3 py-1 text-sm font-bold text-black">V2 BUILD MARKER 2026-04-21 08:20 AM</div>
