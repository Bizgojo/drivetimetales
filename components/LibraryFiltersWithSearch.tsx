    ...
    <>
      <div style={{ padding: '0.5rem 0.75rem', backgroundColor: '#1e293b' }}>
        ...
        <div style={{ display: 'flex', gap: '0.3rem', marginBottom: '0.3rem', position: 'relative' }}>
          ...
          <div style={{ position: 'relative', flex: 1.5 }}>
            <button 
              ...
              style={{ ...btnStyle(showMoreDropdown), width: '100%' }}
            >
              More ▼
            </button>
            {showMoreDropdown && (
                ...
                {ALL_GENRES.map(g => (
                  <button 
                    ...
                    style={{ 
                      ...
                      backgroundColor: selectedGenre === g.key ? '#f97316' : 'transparent', 
                      color: 'white', 
                      border: 'none', 
                      textAlign: 'left', 
                      cursor: 'pointer', 
        ...
        <div style={{ display: 'flex', gap: '0.4rem', alignItems: 'center' }}>
          ...
          <button
            onClick={openSearch}
            style={{
              backgroundColor: searchQuery ? '#f97316' : '#334155',
              color: 'white',
      ...
      {searchQuery && !showSearchScreen && (
        <div style={{ 
          ...
          <span style={{ color: 'white', fontSize: '13px' }}>
            Searching {searchType}: "{searchQuery}"
          </span>
          <button 
            onClick={clearSearch} 
            style={{ 
      ...
      {showSearchScreen && (
        <div style={{
          ...
          {/* Title / Author toggle - large and obvious */}
          <div style={{ 
            display: 'flex', 
            gap: '0.75rem', 
            marginBottom: '1.5rem',
            ...
            <button
              ...
              style={{
                padding: '1rem 2rem',
                borderRadius: '12px',
                border: searchType === 'title' ? '3px solid #f97316' : '3px solid #475569',
                backgroundColor: searchType === 'title' ? '#f97316' : 'transparent',
                color: 'white',
                fontSize: '18px',
                fontWeight: 'bold',
                cursor: 'pointer'
            ...
            <button
              ...
              style={{
                padding: '1rem 2rem',
                borderRadius: '12px',
                border: searchType === 'author' ? '3px solid #f97316' : '3px solid #475569',
                backgroundColor: searchType === 'author' ? '#f97316' : 'transparent',
                color: 'white',
                fontSize: '18px',
                fontWeight: 'bold',
                cursor: 'pointer'
          ...
          {/* White search input - like typing on paper */}
          <div style={{ marginBottom: '1.5rem' }}>
            <input
              type="text"
              placeholder={`Type ${searchType} here...`}
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            <button
              ...
              style={{
                ...
                borderRadius: '12px',
                border: 'none',
                backgroundColor: tempSearchQuery.trim() ? '#22c55e' : '#334155',
                color: 'white',
                fontSize: '18px',
                fontWeight: 'bold',
                cursor: tempSearchQuery.trim() ? 'pointer' : 'not-allowed'
              }}
            >
              🔍 Search
            </button>
