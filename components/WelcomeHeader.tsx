...
export default function WelcomeHeader({ credits }: WelcomeHeaderProps) {
  ...
  // After 2 cycles (30 seconds), hide the cars
  useEffect(() => {
  ...
  return (
    <div style={{ textAlign: 'center', paddingTop: '1.5rem', paddingBottom: '0.5rem' }}>
      ...
      <p className="text-lg text-orange-400 font-semibold" style={{ marginBottom:
ls -la ~/Downloads/*.tsx
cat > ~/Projects/drivetimetales/components/WelcomeHeader.tsx << 'ENDOFFILE'
'use client'
