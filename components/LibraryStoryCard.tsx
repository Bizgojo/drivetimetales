...
export type CanonCardItem = {
  ...
  // Marc 2026-07-13 (c53363f3): series Continue shows "Continue / Episode ##" —
  // resume-target episode number resolved from the playlist by the page.
  episodePlaylist?: Array<{ id: string; episode_number?: number | null }> | null
