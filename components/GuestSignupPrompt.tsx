  ...
  return (
    <div style={{ position: 'fixed', inset: 0, backgroundColor: '#0f172a', zIndex: 100, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      ...
      <p style={{ color: 'white', fontSize: '14px', textAlign: 'center', lineHeight: 1.6, marginBottom: '32px', maxWidth: '300px' }}>
        You've listened to {storiesPlayed} {storiesPlayed === 1 ? 'story' : 'stories'}. Start your <strong style={{ color: '#22c55e' }}>14-day free trial</strong> to keep listening.
      </p>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%', maxWidth: '320px' }}>
        ...
        <Link href="/signin" style={{ width: '100%', background: '#1e293b', color: 'white', padding: '14px', borderRadius: '14px', fontSize: '15px', fontWeight: 700, textAlign: 'center', textDecoration: 'none', display: 'block' }}>
          Already have an account? Sign In
        </Link>
      </div>
      <p style={{ color: '#475569', fontSize: '11px', marginTop: '20px', textAlign: 'center' }}>
        Credit card required. You won't be charged until the trial ends.
      </p>
    </div>
  )
}
