...
export default function StickyHeader({ showBack = true }: StickyHeaderProps) {
  ...
  return (
    <header style={{ position: 'sticky', top: 0, zIndex: 50, backgroundColor: '#020617', borderBottom: '1px solid #1e293b', padding: '0.75rem 1rem' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', maxWidth: '64rem', margin: '0 auto' }}>
        {showBack ? (
          <button onClick={() => router.back()} style={{ width: '2.75rem', height: '2.75rem', borderRadius: '50%', backgroundColor: '#334155', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }} aria-label="Go back">
