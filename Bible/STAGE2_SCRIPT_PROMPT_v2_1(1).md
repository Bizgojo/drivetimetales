...
Belle B uses ElevenLabs voice ID `KWDD3Wyq30ZF5NEL01EJ`. She voices every intro and outro for every story on the platform. The header of every script must read `ANNOUNCER: Belle B`.
...
*STAGE2_SCRIPT_PROMPT.md — Endless Tales · Version 2.1 · April 2026*
