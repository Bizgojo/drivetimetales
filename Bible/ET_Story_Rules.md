...
The ANNOUNCER outro for a series episode must tease the next episode specifically — name a character, threat, or event that will appear next.

> *Example: "Next time on [Series]: Sheriff Holt discovers the body — and the killer is closer than he thinks."*

Generic sign-offs like "tune in next time" are forbidden.
